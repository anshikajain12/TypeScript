const numbersFilter:number[]= [1,2,3,4,5]
...
const namesFilterArray = names1.filter((str:string)=>str.length>3)
console.log(namesFilterArray)


//given an array of string filter out the names of the letter with 'A'
const namesFilterArray1 = names1.filter((str:string)=>str.startsWith('A'))
